    ...
    methods: {
        ...
        async updateStar() {
            try {
                ...
                const index = this.stars.findIndex(
                    star => star.id === this.editingStar.id
                )
                if (index !== -1) {
        ...
        handleFileUpload(event) {
            ...
            if (this.showEditForm) {
                this.editingStar.newImage = newImage
            } else {
                this.starForm.image = newImage
            }
        }
    }
}
